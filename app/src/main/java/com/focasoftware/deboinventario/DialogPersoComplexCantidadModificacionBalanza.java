 ...
 *
 */
public  class DialogPersoComplexCantidadModificacionBalanza extends Dialog implements GestionarioTecladoVirtual{	
	 ...
	 * @param listenerReset
	 */
	public DialogPersoComplexCantidadModificacionBalanza (@NonNull Context context, int tipo_operacion, float valor_inicial,
