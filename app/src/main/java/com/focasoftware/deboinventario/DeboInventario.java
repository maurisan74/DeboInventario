...
public class DeboInventario extends Activity implements DialogPersoSimple, Wifi {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		image_debo.setImageDrawable(getResources().getDrawable(R.drawable.icono_inventario_sub));
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == ParametrosInventario.REQUEST_CODIGO_BARRA && resultCode == RESULT_OK) { }
		// 1 Si volvimos de las preferencias actualiza la version y n tablet
