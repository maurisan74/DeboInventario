        ...
        protected String doInBackground(Context... arg0) {
            ...
            if (bddYaCargada == false) {
                ...
                try {
                    ...
                    pasoInventario = (int) Math.floor((95 - 30) / setNumerosInventarios.size());
                    carga = 30;
...
//            public boolean onLongClick(View v) {
//                try {
//                    OutputStreamWriter fout = new OutputStreamWriter(openFileOutput("deboInventarioExport.xml", Context.MODE_PRIVATE));
//
...
//
////				try {
////					FileInputStream fIS = new FileInputStream (new File("/data/data/com.foca.deboInventario/deboInventarioExport.xml"));
...
////				File file = new File("/data/data/com.foca.deboInventario/deboInventarioExport.xml");
...
////				try
////				{
////					OutputStreamWriter fout= new OutputStreamWriter(openFileOutput("/data/data/com.foca.deboInventario/deboInventarioExport.xml", Context.MODE_PRIVATE));
////
////					fout.write("Texto de prueba.");
////					fout.close();
////				}
...
//                                        } catch (ExceptionBDD e) {
//
//                                            log.log("[-- 1073 --]" + e.toString(), 4);
//                                            e.printStackTrace();
//                                        } catch (Exception e) {
//
//                                            log.log("[-- 1077 --]" + e.toString(), 4);
//                                            e.printStackTrace();
//                                        }
//
//                                        dialogoBorrarInventario.dismiss();
...
//                                    public void onClick(View v) {
//
//                                        log.log("[-- --]" + "Se presiono cancelar", 0);
//                                        dialogoBorrarInventario.cancel();
//                                    }
//                                };
//
...
//                                hashmapUnInventario.put(ParametrosInventario.bal_bdd_inventario_estado, String.valueOf(ParametrosInventario.INVENTARIO_ABIERTO));
...
//                i = 3;
//                if (carpetaFotos.listFiles() != null) {
//                    if (Objects.requireNonNull(carpetaFotos.listFiles()).length > 0) {
//						i = 4;
//						HttpSender senderFotos;
//						try {
//							senderFotos = new HttpSender(Parametros.CODIGO_SOFT_DEBOINVENTARIO);
...
//						}
//
//						for (File unaFoto : Objects.requireNonNull(carpetaFotos.listFiles())) {
//							result &= senderFotos.send_foto(ParametrosInventario.URL_CARPETA_FOTOS + unaFoto.getName());
//						}
//					}
//                }
