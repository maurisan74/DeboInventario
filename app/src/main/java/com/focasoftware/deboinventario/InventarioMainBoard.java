...
//                showSimpleDialogOK(titulo, mensaje).show();
//                try {
//                    File destFile = new File(ParametrosInventario.URL_CARPETA_DATABASES + "DB_INVENT");
//                    File sourceFile = new File(ParametrosInventario.CARPETA_LOGDATOS + "DB_INVENT.sqlite");
//                    copyFile(sourceFile, destFile);
//                    Log.e("mensaje, sourceFile", sourceFile.toString());
//                    Log.e("mensaje, destFile", destFile.toString());
//                } catch (Exception e) {
//                    log.log(e.toString(), 4);
//                    showSimpleDialogOK("IMPORTACION DE BASE DE DATOS", "Se interrumpio, intentelo nuevamente.\n" + "Si el error persiste, reporte el archivo log a Servicio Tecnico").show();
//                }
//
...
//                                contador--;
//                            } while (!control_buena_exportacion() && contador >= 0);
//                        } catch (ExceptionBDD e) {
//                            showSimpleDialogOK("Error", "Generacion del documento XML imposible: " + e.getComentario()).show();
//                            cerrarMenuEspera();
//                            return;
//                        } catch (Exception e) {
//                            showSimpleDialogOK(
...
//                        if ((!control_buena_exportacion()) || contador < 0) {
//                            // Entra aca, por que?
//                            showSimpleDialogOK(
...
//     */
//
//    public void onActivityResult(int requestCode, int resultCode, Intent intentRespondido) {
//        try {
...
//                            HashMap<String, String> datosUnArticulo = hashmapDetallesTodosInventarios.get(numeroInventario).get(codigosArticulo);
//
//                            // A partir de este hashmap recuperamos el objeto
//                            // ARTICULO:
//                            System.out.println("::: InventarioMainboard 830 recupera objeto");
//                            Articulo articulo = new Articulo(
//                                    Integer.parseInt(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_sector)),
//                                    Integer.parseInt(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_codigo)),
//                                    Integer.parseInt(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_balanza)),
//                                    Integer.parseInt(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_decimales)),
//                                    new ArrayList<String>(Arrays.asList(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_codigo_barra).split(","))),
//                                    new ArrayList<String>(Arrays.asList(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_codigo_barra_completo).split(","))),
//                                    Integer.parseInt(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_inventario)), datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_descripcion),
//                                    Double.parseDouble(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_existencia_venta)), Double.parseDouble(datosUnArticulo
//                                            .get(ParametrosInventario.bal_bdd_articulo_existencia_deposito)),
//                                    Integer.parseInt(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_depsn)),
//                                    Double.parseDouble(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_precio_venta)),
//                                    Double.parseDouble(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_precio_costo)));
...
//                    try {
//
//                        matrizArticulosCadaInventario.put(numInventario, bdd.selectArticulosCodigosConNumeroInventario(numInventario));
//                    } catch (ExceptionBDD e) {
//
...
//     * <p>
//     * 6 Creacion de estructuras y la linea del inventario dinamico
//     *
//     * @throws ExceptionBDD
//     * @throws Exception
//     */
...
//        while (iterator_inventarios_id.hasNext()) {
//
//            // Recupermos los datos:
//            final int id_inventario = iterator_inventarios_id.next();
//
//            if (id_inventario > 0) {
//                final HashMap<String, String> hashmapUnInventario = matrizInventarios.get(id_inventario);
//
//                // Consulta de la completud del inventario:
//                ArrayList<Integer> listaEstadisticas = bdd.selectEstadisticasConIdInventario(id_inventario);
...
//        // CREACIN DE LA LINEA:
//        LayoutInflater inflater = (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);
//        TableRow nuevaLinea = (TableRow) inflater.inflate(R.layout.z_lineaprogressbar_mainboard, null);
...
//            if(condR == -1){
//                String fechaIVta = hashmapInventarioVenta.get(ParametrosInventario.bal_bdd_inventario_fechaInicio).trim();
//                fecha = hashmapInventarioVenta.get(ParametrosInventario.bal_bdd_inventario_fechaInicio).trim();
//            }else if(condR == -2){
//                String fechaIDep = hashmapInventarioDeposito.get(ParametrosInventario.bal_bdd_inventario_fechaInicio).trim();
...
//            if(condR == -1){
//
//                estadoCandadoVta = Integer.parseInt(hashmapInventarioVenta.get(ParametrosInventario.bal_bdd_inventario_estado));
//
...
//                            bdd.updateInventario(ParametrosInventario.ID_INV_DIN_VTA, ParametrosInventario.INVENTARIO_CERRADO);
//                            hashmapInventarioVenta.put(ParametrosInventario.bal_bdd_inventario_estado, String.valueOf(ParametrosInventario.INVENTARIO_CERRADO));
//                            iv.setImageDrawable(getResources().getDrawable(
//                                    R.drawable.candado_cer));
...
//                            bdd.updateInventario(ParametrosInventario.ID_INV_DIN_VTA, ParametrosInventario.INVENTARIO_ABIERTO);
//                            hashmapInventarioVenta.put(ParametrosInventario.bal_bdd_inventario_estado, String.valueOf(ParametrosInventario.INVENTARIO_ABIERTO));
...
//                            bdd.updateInventario(ParametrosInventario.ID_INV_DIN_DEP, ParametrosInventario.INVENTARIO_CERRADO);
//                            hashmapInventarioDeposito.put(ParametrosInventario.bal_bdd_inventario_estado, String.valueOf(ParametrosInventario.INVENTARIO_CERRADO));
...
//                            bdd.updateInventario(ParametrosInventario.ID_INV_DIN_DEP, ParametrosInventario.INVENTARIO_ABIERTO);
//                            hashmapInventarioDeposito.put(ParametrosInventario.bal_bdd_inventario_estado, String.valueOf(ParametrosInventario.INVENTARIO_ABIERTO));
//                            iv.setImageDrawable(getResources().getDrawable(R.drawable.candado_ab));
//                        }
//
//
...
//     * @param boton
//     */
//    private void ClicBoton(Button boton) {
...
//                    intentInventario.putExtra(ParametrosInventario.extra_numeroInventarioDinDepo, ParametrosInventario.ID_INV_DIN_DEP);
...
//                    "Inv. dinamico "
//                            + String.valueOf(ParametrosInventario.ID_INV_DIN_DEP)
//                            + " de deposito", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()), "",
//                    ParametrosInventario.INVENTARIO_ABIERTO,
//                    ParametrosInventario.COD_LUGAR_INVENTARIO_DEPO);
//
//            // 2.2 Insertamos en la base de datos:
...
//         */
//
//        protected void onPostExecute(RespuestasExportar result) {
//            super.onPostExecute(result);
//
...
//     * @return
//     */
//    private int min(ArrayList<Integer> lista) {
...
public class InventarioMainBoard extends Activity implements DialogPersoSimple,
     ...
     */
    private DialogPersoComplexExport dialogoPrincipioExport, dialogoPrincipioImport;
    /*
     * Dialogo de aviso para borrar inventarios comunes, se muestra cuando
     * presionamos de forma prolongada un boton de un inventario com�n
     */
    private DialogPersoComplexSiNo dialogoBorrarInventario;
    /*, dialogoCreacionInvDinamico
     * Dialogo que se muestra para preguntar si desea seguir trabajando con el inventario dinamico actual o empezar de cero
     */
    private DialogPersoComplexSiNo dialogoContinuarInventario;
    /*
     * Dialogo para confirmar la decisi�n de borrar el inventario din�mico
    ...
    private DialogPersoComplexSiNoOpcs dialogoCreacionInvDinamico;
    /*
     * ProgresDialogs para mostrar progresos de procesos como exportacion e importacion
     */
    private ProgressDialog popupCarga, popupEspera;
    private int inventarios_elegidos = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Exportar_BD.setOnLongClickListener(v -> {
            log.log("Se presiono el boton Exportar BD", 3);
            String titulo = "EXPORTACION DE BASE DE DATOS";
            String mensaje = "Se exporto la base de datos";
            showSimpleDialogOK(titulo, mensaje).show();
        ...
        botonExportar.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                try {
                    ...
                    //	inventarios_elegidos = inventarios_a_exportar.get(0);
                    numero_inventarios_cerrados = inventarios_a_exportar.size();
                    if(numero_inventarios_cerrados>=1)  inventarios_elegidos = inventarios_a_exportar.get(0);
                    System.out.println("::: InventarioMainBoard 351 numero_inventarios_cerrados " + numero_inventarios_cerrados);
                } catch (ExceptionBDD e) {
                    log.log("[-- 285 --]" + e.toString(), 4);
                    log.log("[-- 286 --]" + "Error, la exportacion se cancelo", 3);
                    e.printStackTrace();
                    Toast.makeText(ctxt, "Error, la exportacion se cancelo", Toast.LENGTH_LONG).show();
                    return false;
                }
                ...
                View.OnClickListener listenerUsb = new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            showSimpleDialogOK("Error", "Imposible exportar en el " + Dispositivo_Export+ ". Verifique que este correcamente " + "conectado").show();
                            cerrarMenuEspera();
                            return;
                        }
                        ...
                        if ((!control_buena_exportacion()) || contador < 0) {
                            // Entra aca, por que?
                            showSimpleDialogOK("ERROR DE EXPORTACION", "Los archivos XML de exportacion del "+ Dispositivo_Export + ", no han podido ser creados con exito.").show();
                            return;
                        }
                        cerrarMenuEspera();
                    }
            ...
            public void onClick(View v) {
                ...
                View.OnClickListener listenerWifi = new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intentWifi = new Intent(InventarioMainBoard.this, WiFiControlador.class);
                        startActivityForResult(intentWifi, Parametros.REQUEST_WIFI_IMPORT);
                    }
                };
                ...
                View.OnClickListener listenerUsb = new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        log.log("[-- 432 --]" + "Se presiono exportar por usb", 0);
                        System.out.println("InventarioMainBoard 499 ExportarUSB");
                        Intent intentUSB = new Intent(InventarioMainBoard.this, UsbProvider.class);
                        // intentUSB.putExtra(Parametros.extra_uri_usb,
                        // Parametros.PREF_USB_IMPORT);
                        intentUSB.putExtra(Parametros.extra_uri_usb, ParametrosInventario.CARPETA_ATABLET);
                        // intentUSB.putExtra(Parametros.extra_uri_usb,
                        // "/data/data/com.foca.deboInventario/test/");
                        startActivityForResult(intentUSB, Parametros.REQUEST_USB);
                        finish();
                    }
                };
                ...
                log.log("[-- 464 --]" + "Se mu8estra un pop up con las opcioners de importacion", 3);
            }
        });
        botonSalir.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ImageView imageV = (ImageView) v;
                    imageV.setBackgroundColor(getResources().getColor(R.color.orange));
                } else if (event.getAction() == MotionEvent.ACTION_UP) {
                    ImageView imageV = (ImageView) v;
                    imageV.setBackgroundColor(Color.TRANSPARENT);
...
//             if (requestCode == ParametrosInventario.REQUEST_INVENTARIO && resultCode == RESULT_OK) {
//                 int numeroInventario =bundle.getInt(ParametrosInventario.extra_numeroInventario);
//                 int  idLineaSeleccionada = ParametrosInventario.ID_LINEAS +
//              numeroInventario;
//              TableRow estaLinea = (TableRow)findViewById(idLineaSeleccionada);
//              estaLinea.setBackgroundColor(Color.GREEN);
//              refreshLinea(estaLinea);
        ...
        protected String doInBackground(Context... arg0) {
            ...
            if (bddYaCargada == false) {
                ...
                try {
                    ...
                    HttpReader readerHttp = null;
                    try {
                        readerHttp = new HttpReader(Parametros.PREF_URL_CONEXION_SERVIDOR, ParametrosInventario.FONCION_CARGAR_ARTICULOS, listaInventariosSeleccionados);
                    } catch (ExceptionHttpExchange e) {
                    ...
                    // matriz de matriz de matriz ( matriz^3 ):
                    int countSeguridad = 3;
                    LinkedHashMap<Integer, LinkedHashMap<HashMap<String, Integer>, HashMap<String, String>>> hashmapDetallesTodosInventarios = readerHttp.readDetallesInventarios();


                    while (countSeguridad > 0
                            && hashmapDetallesTodosInventarios.size() <= 0) {
                        hashmapDetallesTodosInventarios = readerHttp.readDetallesInventarios();
                        System.out.println("::: InventarioMainboard 780");
                        countSeguridad--;
                        popupSubir(20 + 4 - countSeguridad);
                    }
                    ...
                    // Empezamos la lectura de la base de datos:
                    Set<Integer> setNumerosInventarios = hashmapDetallesTodosInventarios.keySet();
                    Iterator<Integer> ite = setNumerosInventarios.iterator();
                    /*
                     * Variables auxiliares
                     */
                    int pasoInventario = (int) Math.floor((95 - 30) / setNumerosInventarios.size());
                    double carga = 30;
                    ...
                    while (ite.hasNext()) {
                        ...
                        Set<HashMap<String, Integer>> setCodigosArticulos = hashmapDetallesTodosInventarios.get(numeroInventario).keySet();
                        Iterator<HashMap<String, Integer>> ite2 = setCodigosArticulos.iterator();
                        long cantidadArticulosEsteInventario = setCodigosArticulos.size();
                        double pasoArticulo = (double) ((double) pasoInventario / (double) cantidadArticulosEsteInventario);
                        ...
                        while (ite2.hasNext() == true) {
                            ...
                            Articulo articulo = new Articulo(
                                    ...
                                    new ArrayList<String>(Arrays.asList(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_codigo_barra).split(","))),
                                    new ArrayList<String>(Arrays.asList(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_codigo_barra_completo).split(","))),
                                    Integer.parseInt(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_inventario)),
                                    datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_descripcion),
                                    Double.parseDouble(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_existencia_venta)),
                                    Double.parseDouble(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_existencia_deposito)),
                                    Integer.parseInt(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_depsn)),
                                    Double.parseDouble(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_precio_venta)),
                                    Double.parseDouble(datosUnArticulo.get(ParametrosInventario.bal_bdd_articulo_precio_costo)));
                            bdd.insertArticuloEnBdd(articulo);
                        ...
                        // Guardamos en memoria la lista de los articulos de
                        // este inventario:
                        matrizArticulosCadaInventario.put(numeroInventario, listaCodigosArticulos);
                        // carga += pasoArticulo;
                        // popupSubir(proximoPaso);
    ...
    private void refreshTablaPrincipal() throws ExceptionBDD, Exception {
        ...
        while (iterator_inventarios_id.hasNext() == true) {
            ...
            if (id_inventario > 0) {
                ...
                LayoutInflater inflater = (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);
                TableRow nuevaLinea = (TableRow) inflater.inflate(R.layout.z_lineaprogressbar_mainboard, null);
                nuevaLinea.setId(ParametrosInventario.ID_LINEAS + id_inventario);

                // Elemento 1 = boton:
                Button b = (Button) nuevaLinea.findViewById(R.id.LPB2_boton);
                if (id_inventario >= 0) { b.setText("Inventario " + String.valueOf(id_inventario));
                } else { b.setText("Inv. dinamico " + String.valueOf(Math.abs(id_inventario)));
                }
                b.setId(ParametrosInventario.ID_BOTONES + id_inventario);
...
//		int id_inv_ficticio = -1;
        ...
        if (hayDinamicos) {
            ...
            if(condicionRadio){
                ...
                listaEstadisticasVenta = bdd.selectEstadisticasConIdInventario(ParametrosInventario.ID_INV_DIN_VTA);

                cantidadArticulosEnInventario = listaEstadisticasVenta.get(0);
                articulosYaContadosEnInventario = listaEstadisticasVenta.get(1);
            }else{
                listaEstadisticasDepo = bdd.selectEstadisticasConIdInventario(ParametrosInventario.ID_INV_DIN_DEP);
                cantidadArticulosEnInventario = listaEstadisticasDepo.get(0);
                articulosYaContadosEnInventario = listaEstadisticasDepo.get(1);
            }
//			ArrayList<Integer> listaEstadisticasVenta = bdd
...
//					+ listaEstadisticasDepo.get(1);
            ...
            listaEstadisticas.add(articulosTotalesQueInventariar);
            listaEstadisticas.add(articulosTotalesQueInventariar - articulosNonInventariados);
            listaEstadisticas.add(articulosNonInventariados);
            cantidadArticulosEnInventario = listaEstadisticas.get(0);
            articulosYaContadosEnInventario = listaEstadisticas.get(1);
        }
...
//				if (ParametrosInventario.InventariosVentas == true) {
    ...
    public void refreshLinea(TableRow unaLinea) throws ExceptionBDD {
        try {
            ...
            RelativeLayout unRelativeLayout = (RelativeLayout) unaLinea.getChildAt(1);
            ProgressBar unaProgressBar = (ProgressBar) unRelativeLayout.getChildAt(0);
            TextView unTextoDeProgressBar = (TextView) unRelativeLayout.getChildAt(1);
            TextView unTextoDeProgresion = (TextView) unaLinea.getChildAt(2);

            int newValue = (int) Math.floor((double) articulosYaContadosEnInventario / (double) cantidadArticulosEnInventario * (double) 100);
            unaProgressBar.setProgress(newValue);

            unTextoDeProgressBar.setText(String.valueOf(newValue) + " %");

            unTextoDeProgresion.setText(String.valueOf(articulosYaContadosEnInventario)
                    + " / "
                    + String.valueOf(cantidadArticulosEnInventario));
    ...
    /*
     * Controla si se han medido todos los inventarios y si es necesario exportarlos
    ...
    private void controlFin() throws ExceptionBDD {
        if (estanTerminadosTodosLosInventarios()) {
            ...
            /*
             * Dialog donde se informa que se han realizado todas las mediciones para que proceda a exportar
             */
            AlertDialog.Builder dialogoFin = new AlertDialog.Builder(this);
            dialogoFin
                    .setTitle("Fin de las mediciones")
                    .setMessage("Todas los inventarios han sido procesados exitosamente.\n"
                                    + "Por favor, dirijase hacia el central de control para descargar los datos de los inventarios al servidor.")
                    .setCancelable(false)
    ...
    protected class ExportarDatos extends AsyncTask<Context, Integer, RespuestasExportar> {
        ...
        protected RespuestasExportar doInBackground(Context... arg0) {
            ...
            if (ParametrosInventario.ProductosNoContabilizados == 2) {
                ...
                if(inventarios_elegidos==-1 || inventarios_elegidos == -2){
                    ...
                    for (Referencia ref : Referencias) {
                        try {
                            System.out.println("::: PASO por InventarioM 5");
                            Articulo articulo = bd.selectArticuloConCodigos(ref.getSector(), ref.getArticulo(), -1);
                            if (articulo == null) {
                                Date fechaHoy = new Date();
                                ArrayList<String> codbar = new ArrayList<String>();
                                ArrayList<String> codbarcompleto = new ArrayList<String>();
            ...
            try {
                ...
                try {
                    if (result) {
                        ...
                        for (int inventario : listaInventariosCerrados) {
                            ...
                            // 4 A ver si borrar estuvo activado o no,o si es dinamico el inventario:
                    ...
                    log.log("[-- catch 2001 --]" + e2.toString(), 4);
                    e2.printStackTrace();
                    return new RespuestasExportar(RespuestasExportar.CODIGO_ERROR, "Error Export - Export a la BDD - Inventarios - " + e2.toString());
                } catch (ExceptionBDD e) {
                    log.log("[-- 2022 --]" + e.toString(), 4);
                ...
                if (carpetaFotos.listFiles() != null) {
                    if (carpetaFotos.listFiles().length > 0) {
                        i = 4;
                        HttpSender senderFotos;
                        try {
                ...
                try {
                    RegistroLog.log(ParametrosInventario.URL_ARCHIVO_LOG, new Date(), "Mauricio BOARD", "0", "Export: 40 %");
                } catch (Exception e) {
                    e.printStackTrace();
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (clase == null) {
                            ...
                            try {
                                ...
                                log.log("[-- 2257 --]" + e.toString(), 4);
                                showSimpleDialogOK("ERROR DE EXPORTACION", "Generacion del documento XML imposible: " + e.getComentario()).show();
                                return;
                            } catch (Exception e) {
                                log.log("[-- 2264 --]" + e.toString(), 4);
                                showSimpleDialogOK("ERROR DE EXPORTACION", "Imposible exportar en el " + Dispositivo_Export + ". Verifique que este " + "correctamente conectado").show();
                                return;
                            }

                            if (contador < 0) {
                                showSimpleDialogOK("ERROR DE EXPORTACION", "Los archivos XML de exportacion no han podido ser creados con exito. " + "Verifique su correctitud").show();
                                return;
                            }
                        ...
                        // Si CLASE es not NULL, es import:
                            ...
                            Intent intentUSB = new Intent(
                                    InventarioMainBoard.this, UsbProvider.class);
                            intentUSB.putExtra(Parametros.extra_uri_usb, Parametros.PREF_USB_IMPORT);
                            startActivity(intentUSB);
                            finish();
                        }
                    }
     ...
     * @throws Exception
     */
    private void export_usb(boolean borrar_despues) throws ExceptionBDD,Exception {
        // Para prueba descomentar la linea siguiente para que encuentre los
        // archivos
        // ParametrosInventario.PREF_USB_EXPORT =
        // "data/data/com.foca.deboInventario/test/";
        ...
        // 2 Fabricamos la lista de todos los inventarios que estn cerrados:
        ArrayList<Integer> listaInventariosCerrados = bdd.selectInventariosCerradosEnBdd();
        if (listaInventariosCerrados.size() <= 0) {
            log.log("[-- 2433 --]" + "Debe haber por lo menos un inventario cerrado", 3);
            Toast.makeText(ctxt, "Debe haber por lo menos un inventario cerrado", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        File carpeta_fuente = new File(ParametrosInventario.URL_CARPETA_USB_EXPORT);
        for (File archivo : carpeta_fuente.listFiles()) {
            File carpeta_destino = new File(ParametrosInventario.CARPETA_ATABLET);
            File archivo_destino = new File(ParametrosInventario.CARPETA_DESDETABLET + archivo.getName());
            // boolean existecarpetaDest=carpeta_destino.exists();
            // boolean existearchivo=archivo.exists();
            try {
                if (carpeta_destino.exists() && archivo.exists()) {
                    // Puede arrojar la IOExc
                    archivo_destino.createNewFile();
                    // Puede arrojar la IOExc
                    copyFile(archivo, archivo_destino);
                ...
                // Genera este error
                texto_error = "Un error occurio al momento de copiar los archivos al" + Dispositivo_Export;
                estado_exportacion = false;
            }
        ...
        // 5 Se verifica la correcta exportacion, si es positiva se borran los
        // inventarios
        if (estado_exportacion && control_buena_exportacion()) {
            // Los borramos si nos han marcado o si son dinamicos
            for (int num_inv : listaInventariosCerrados) {
                if (borrar_despues || num_inv < 0) {

                    bdd.borrarInventarioConArticulos(num_inv);
                }
            }

            showSimpleDialogOK("Exportacion exitosa", "Datos correctamente exportados en el " + Dispositivo_Export).show();
        }// Solucion temporaria 08/05/2012
        // else if ()
        else {
            // Se saca para que no moleste despues
    ...
    private void control_integridad_tablas() {
        try {
            ...
            ArrayList<Integer> lista_numeros_inventarios = bdd.selectInventariosNumerosEnBdd();

            if (lista_numeros_inventarios != null) {
                for (int id_inv : lista_numeros_inventarios) {
                    System.out.println("::: InventarioMainBoard 2769 " + lista_numeros_inventarios);
                    System.out.println("::: InventarioMainBoard 2769 " + bdd.selectArticulosCodigosConNumeroInventario(
                                    id_inv));
                    if (id_inv >= 0 && bdd.selectArticulosCodigosConNumeroInventario(id_inv).size() <= 0) {
                        bdd.borrarInventarioConArticulos(id_inv);
                    }
                }
            }
