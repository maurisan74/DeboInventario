 ...
 *
 */
public class DialogPersoComplexCantidadMasMenosBalanza extends Dialog {	
	 ...
	 */
	public DialogPersoComplexCantidadMasMenosBalanza (@NonNull Context context, @NonNull String titulo, float cantidad_inicial,
		...
		ctxt = context;
		System.out.println("::: MasMenos BALANZA ");
		...
		super.setContentView(R.layout.z_dialogpersocomplexcantidad_masmenos_balanza);
