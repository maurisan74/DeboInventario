...
// * venta y deposito. Permite ver los detalles de algn artculo y modificar sus
// * cantidades. Permite agregar y en un futuro eliminar artculos de los
// * inventarios.
// *
// * @author GuillermoR
// *
// */
//public class PaginaInventarioDinamico extends Activity implements
//		DialogPersoSimple {
//
//	/*
...
//
//	// private ProgressDialog aguarde=new ProgressDialog(ctxt);
//
//	/**
//	 * Dialogs de mensajes
//	 */
...
//
//		/*	checkBoxT.setOnCheckedChangeListener(new OnCheckedChangeListener() {
...
//
//		System.out.print("::::: BALANZA ACTIVADA ? " + condicionBalanza);
//		int condi = 0;
//		if(condicionb == true){
//			condi=1;
//		}else{
...
//			case 1:
//
//				setContentView(R.layout.xml_paginainventario_dinamico);
//				System.out.println("::: PaginaInventarioDinamico 266 condicion 1  "+ condi);
//				break;
//			default:
//				System.out.println("::: PaginaInventarioDinamico 269 condicion 2 "+ condi);
//				setContentView(R.layout.xml_paginainventario_dinamicoss);
//				break;
//		}
//
...
//		log.log("[-- 223 --]" + "Inicica Inventario Dinamico", 2);
//
//		// BUNDLES:
...
//		if (bundle != null) {
//			inventario_numero_en_curso = condR;
//		}
//
...
//		}
//
//		System.out.println("::: PaginaInventarioDinamico radioBVenta="+radioBVenta);
//		System.out.println("::: PaginaInventarioDinamico radioBDepo="+radioBDepo);
//
...
//		System.out.println("::: PaginaInventarioDinamico 531 salio refrescarencabezado 8");
//		// 7 Refrescar mensaje inferior
//		refrescarMensaje();
//
//		log.log("[-- 307 --]"
...
//		// Buscar el nuevo inventario y Actualizar la lista de productos
...
//		System.out.println("::: El numero de inventario que se recibe "+inventario_numero_en_curso);
//		listaArticulosCompleta = null;
//		try {
//			// Lo buscamos en la BD
//			inventarioEnCurso = bdd
//					.selectInventarioConNumero(inventario_numero_en_curso);
//			// Cargamos sus articulos en la lista
//			listaArticulosCompleta = bdd
//					.selectArticulosConNumeroInventario(inventario_numero_en_curso);
//
//		} catch (ExceptionBDD e) {
...
//			showSimpleDialogOK("Error", e.toString()).show();
//		}
//		System.out.println("::: Pagina de inventario 1");
//
//
...
//		refrescarEncabezado(inventario_numero_en_curso);
//		System.out.println("::: PaginaInventarioDinamico 531 salio refrescarencabezado");
//		// 6 Refrescar mensaje inferior
//		refrescarMensaje();
//		aguarde = ProgressDialog.show(ctxt, "Aguarde",
//				"Aguarde que se carguen los articulos");
...
//		System.out.println("::: PaginaInventarioDinamico cargarArticulosTabla");
//		int con = 0;
//
//
//		try {
//
//			// aguarde=new ProgressDialog(ctxt);
//			// aguarde.show();
...
//
//				System.out.println("::: PaginaInvDin linea ="+ linea);
//
//				// 1.2 Recuperamos los detalles del articulo que va a figurar en
//				// esta linea:
...
//
//				// 1.3 Configuramos los elementos (4 casillas) de la linea:
//				TextView casilla_codigo = (TextView) linea.findViewById(R.id.ZLIN_codigo);
//				TextView casilla_descripcion = (TextView) linea.findViewById(R.id.ZLIN_descripcion);
//				TextView casilla_precio = (TextView) linea.findViewById(R.id.ZLIN_precio);
//				TextView casilla_exisventa = (TextView) linea.findViewById(R.id.ZLIN_existente);
//				EditText casilla_cantidad = (EditText) linea.findViewById(R.id.ZLIN_cantidad);
//				TextView casilla_secreta = (TextView) linea.findViewById(R.id.ZLIN_secreto);
//
//				// 1.4 Calculo de la cantidad de elementos visibles:
//				if (a.esVisible()) { numero_articulos_visibles++; }
//
//				// 1.5 Configuramos los valores de casillas:
//				/* Primera casilla: CODIGO del ARTICULO */
//				if (a.getSector() >= 0) {
//					casilla_codigo.setText(String.valueOf(a.getSector()) + "-" + String.valueOf(a.getCodigo()));
//				} else {
//					casilla_codigo.setText("Nvo. " + String.valueOf(Math.abs(a.getSector())));
//				}
//
...
//				casilla_precio.setText("$ " + new DecimalFormat("0.00").format(a.getPrecio_venta()));
//
//				/* Cuarta casilla: CANTIDAD del ARTICULO */
//				System.out.println("::: PaginaInventarioDinamico 656 CargarArticulos");
//				System.out.println("::: PaginaInventarioDinamico 656 a.getCantidad() " + a.getCantidad());
//
//				if (a.getCantidad() >= 0) {
...
//				}
//
//				/* Casilla Existencia : Venta y Deposito */
//
...
//					if (ParametrosInventario.InventariosVentas ) {
//						existencia = String.valueOf(a.getExis_venta());
//					}else{
//						existencia = String.valueOf(a.getExis_deposito());
//					}
//				}else{
//					existencia = ParametrosInventario.no_disponible;
//				}
//				casilla_exisventa.setText(existencia);
//
//
...
//							//System.out.println("::: ver valor del indice_articulo ="+indice_articulo);
...
//
//					public boolean onLongClick(View linea) {
...
//						//System.out.println("::: PaginaInventario 776 indice_articulo_apuntado" + indice_articulo_apuntado);
//						//System.out.println(":::ACA EENTRO 66");
//						ArticuloVisible a = listaArticulosCompleta
//								.get(indice_articulo_apuntado);
//
//						Intent intentDetallesArticulo = new Intent(
//								PaginaInventarioDinamico.this,
...
//						//	System.out.println("::: PaginaInventario 792 Se descomenta startActivity");
...
//				//listaCodigosDeBarrasOrdenados.add(a.getCodigo());
//
//				paridad = (paridad + 1) % 2;
//			} // end for
//
...
//		System.out.println("::: PaginaInventarioDinamico Refrescartablacentral");
...
//			// aguarde.show();
//			// aguarde=new ProgressDialog(ctxt);
//			// aguarde.show(ctxt,"Aguarde","Aguarde mientras se cargan los artculos");
//
//			// Parametros:
//			int paridad;
//
...
//				listaCodigosDeBarrasOrdenados.add(a.getCodigos_barras());
//				//	System.out.println("::: PID CodigoBarras " + a.getCodigos_barras());
//				//	System.out.println("::: PID Cantidad " + a.getCantidad());
//
//
//				if (a.esVisible() == true) {
//					numero_articulos_visibles++;
...
//				// 3.4 Configuramos los valores de casillas:
//				/* Primera casilla: CODIGO del ARTICULO */
//				if (a.getSector() >= 0) { casilla_codigo.setText(String.valueOf(a.getSector()) + "-" + String.valueOf(a.getCodigo()));
//				} else { casilla_codigo.setText("Nvo. " + String.valueOf(Math.abs(a.getSector()))); }
//
//				/* Segunda casilla: DESCRIPCION del ARTICULO */
//				casilla_descripcion.setText(a.getDescripcion());
//
...
//	 * @param paridad
//	 */
//	private void colorearLinea(TableRow linea, int paridad) {
...
//		// 1ra CASILLA - CODIGO:
//		if (paridad == 1) {
//			casilla_codigo.setBackgroundColor(getResources().getColor(R.color.verde_oscuro_mas));
//		} else {
//			casilla_codigo.setBackgroundColor(getResources().getColor(R.color.verde_oscuro));
//		}
//
//		// 2da CASILLA - DESCRIPCIN:
//		if (paridad == 1) {
//			casilla_descripcion.setBackgroundColor(getResources().getColor(R.color.verde_oscuro_mas));
//		} else {
//			casilla_descripcion.setBackgroundColor(getResources().getColor(R.color.verde_oscuro));
//		}
//
//		// 3ra CASILLA - PRECIO DE VENTA:
//		if (paridad == 1) {
//			casilla_precio.setBackgroundColor(getResources().getColor(R.color.verde_oscuro_mas));
//		} else {
//			casilla_precio.setBackgroundColor(getResources().getColor(R.color.verde_oscuro));
//		}
//
...
//	 * @throws ExceptionBDD
//	 */
//	private void getIndiceArticuloConCB(final String cb) throws ExceptionBDD {
...
//			// if (articulo.getSector() == art.getSector() &&
//			// articulo.getCodigo() == art.getCodigo()) {
//			// indice_articulo_encontrado = listaArticulos.indexOf(art);
//			// }
//			// }
//		}
//
...
//		// }
//		// else {
//		/*Parametro para saber si esta activada la balanza*/
////		boolean condicionBalanza = ParametrosInventario.balanza;
...
//			if (Float.parseFloat(String.valueOf(((TextView) (linea.getChildAt(5))).getText())) == indice_articulo) {
//				System.out.println("::: Paso 4");
//				linea.setBackgroundColor(getResources().getColor(R.color.anaranjado_verde));
...
//				//
//				edittext.setBackgroundColor(getResources().getColor(R.color.anaranjado_verde));
//				edittext.setTextColor(getResources().getColor(R.color.white));
//				System.out.println("::: Paso 5");
//				try {
//
//					//parametroPrimeraSeleccion
//					final float cantidad_producto = Float.parseFloat(String.valueOf(edittext.getText()));
//
...
//
//						public void onClick(View v) {
//							log.log("[-- 1115 --]" + "Se presiona para abrir el cuadro de dialogo de sumar, restar y modificar", 0);
//							/*
//							 * editTT = (EditText)
...
//									valor_a_sumar = validar_valor_string(valor_a_sumar, listaArticulosCompleta.get(indice_on_focus).getDecimales());
//
//									if (valor_a_sumar == "false") {
//										dialogoModificacion.valor_incorrecto(ctxt);
//									} else {
...
//											.get_nuevo_valor();
//									valor_a_restar = validar_valor_string(valor_a_restar, listaArticulosCompleta.get(indice_on_focus).getDecimales());
//
//									if (valor_a_restar == "false") {
//										dialogoModificacion.valor_incorrecto(ctxt);
//									} else {
...
//											.get_nuevo_valor();
//
//									valor_string = validar_valor_string(valor_string, listaArticulosCompleta.get(indice_on_focus).getDecimales());
//
//									if (valor_string == "false") {
//										dialogoModificacion.valor_incorrecto(ctxt);
//									} else {
//										edittext.setText(String
...
//
//
//	private String validar_valor_string(String valor_string, Integer Decimales) {
//		try {
//			Double.parseDouble(valor_string);
//			if (Decimales == 0 && Double.parseDouble(valor_string) - Integer.parseInt(valor_string) > 0) {
//				return "false";
//			}
...
//	 *
//	 */
//	private void seleccionarMostrarIndiceArticuloBalanza(int indice_articulo, String cb) {
...
//				try {
//					boolean condicionBalanza = ParametrosInventario.balanza;
//					//if (cb.length() != 13)  condicionBalanza =  false;
...
//								//quiere decir que ya existe cantidad_actual = Float.parseFloat(String.valueOf(edittext.getText()));
//								//parametroPrimeraSeleccion
//								final float cantidad_producto = Float.parseFloat(String.valueOf(edittext.getText()));
//								//cantidad_actual = Float.parseFloat(String.valueOf(edittext.getText()));
//								//final float cantidad_producto = cantidad_actual;
//								// 3.1 Modificamos la cantidad
//								// Aca, el articulo est y tiene cantidad.
//								// Si estamos en modo +1, no mostramos le menu 3M:
//								System.out.println("::: PID modo_mas_1 " + modo_mas_1);
...
//											public void onClick(View v) {
//
//												log.log("[-- 1173 --]" + "Se presiona para editar texto", 2);
//												editTT = (EditText) dialogoModificacion.findViewById(R.id.Z_DIALOG_cantidad_nueva);
//												System.out.println("::: Que tiene edittext " + editTT);
//												InputMethodManager mgr = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
//												mgr.hideSoftInputFromWindow(editTT.getWindowToken(), 0);
//
//												SystemClock.sleep(20);
//
//												String valor_a_sumar = dialogoModificacion.get_nuevo_valor();
//												System.out.println("::: Que tiene valor_a_sumar " + valor_a_sumar);
//												edittext.setText(String.valueOf(cantidad_producto + Float.parseFloat(valor_a_sumar)));
//
//												dialogoModificacion.dismiss();
//											}
//										};
//										dialogoModificacion = new DialogPersoComplexCantidadModificacion(ctxt, DialogPerso.OPERACION_SUMAR, cantidad_producto, listenerPositivo, listenerNegativo, null);
//										dialogoModificacion.setOnShowListener(new DialogInterface.OnShowListener() {
...
//
//					}else{
//						System.out.println("::: PID 3 que trae " + Float.parseFloat(String.valueOf(edittext.getText())));
//						cantidad_actual = Float.parseFloat(String.valueOf(edittext.getText()));
//					}
//
//				} catch (Exception e) {
...
//		System.out.println("::: PaginaInventarioDinamico deseleccionarLinea");
...
//						Intent i = new Intent(PaginaInventarioDinamico.this,
//								clase);
//						startActivity(i);
//						dialog.dismiss();
//						finish();
...
//
//		System.out.println("::: PaginaInventarioDinamico Filtrar");
//		numero_articulos_visibles = 0;
//		// 1 Configuramos la visibilidad de todos los articulos:
...
//
//							log.log("[-- 2026 --]" + "Cambia de estado rdioVirgen", 4);
//							if (isChecked ) {
...
//							if (isChecked ) {
//								log.log("[-- 2046 --]" + "Cambia de estado rdioHecho", 0);
//								RadioButton rbSin = (RadioButton) dialogo.findViewById(0 + Parametros.ID_RADIOBUTTON);
//								rbSin.setChecked(false);
...
//	 * @throws Exception
//	 */
//	private ArrayList<Integer> getProximosIndicesArticulosVisibles(int indice_actual, boolean hay_indice_on_focus) throws Exception {
...
//				try {
//					if (indice_on_focus >= 0) {
//						TableRow linea = (TableRow) tabla_articulos.getChildAt(indice_on_focus);
...
//						 */
//
//						// Esto se cambia, lo que hay que hacer ahora es meterlo
//						// a la lista de articulos,
//						// agregarlo en la bd y luego remostrar la tabla
//						// View.OnClickListener listenerEleccionRespuesta = new
...
//						// get_indice_con_articulos(articulo_resultado_busqueda);
//						//
//						// if (indice >= 0 && indice == respuestaSeleccionada) {
...
//						//
//						// LinearLayout padre = (LinearLayout)
//						// tableR.getParent();
//						// for (int k = 0 ; k < padre.getChildCount() ; k++) {
//						// LinearLayout tr = (LinearLayout) padre.getChildAt(k);
//						// tr.setBackgroundColor(getResources().getColor(R.color.verde_oscuro));
//						// }
//						// tableR.setBackgroundColor(getResources().getColor(R.color.anaranjado_oscuro));
//						// }
//						// }
//						// };
//
...
//
//										// Abrir el teclado
//										// Buscamos la linea que modificar:
//										// for (int j = 0; j <
//										// NUMERO_LINEAS_EN_TABLA; j++) {
//										// TableRow linea = (TableRow)
//										// tabla_articulos.getChildAt(j);
//										// if
//										// (Integer.parseInt(String.valueOf(((TextView)
//										// (linea
//										// .getChildAt(4))).getText())) ==
//										// indice) {
//										//
...
//							public void onShow(DialogInterface dialog) {
//								log.log("[-- 2847 --]" + "Se muestra el cuador de dialogo de Busqueda", 0);
//								edittextBusqueda = (EditText) dialogoBusqueda.findViewById(R.id.Z_DIALOG_editext);
//								InputMethodManager mgr = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
//								mgr.showSoftInput(edittextBusqueda, InputMethodManager.SHOW_FORCED);
//							}
//						});
//				dialogoBusqueda.show();
//
...
//				if (event.getAction() == MotionEvent.ACTION_DOWN) {
//					imgV.setBackgroundColor(getResources().getColor(R.color.amarillo_oscuro_mas));
//				} else if (event.getAction() == MotionEvent.ACTION_UP) {
//					imgV.setBackgroundColor(getResources().getColor(android.R.color.transparent));
//				}
//				return false;
//			}
//		});
...
//					modo_mas_1 = 1;
//					imageV.setBackgroundColor(getResources().getColor(R.color.anaranjado_oscuro));
//				} else {
//
//					log.log("[-- 2892--]" + "modo_mas_1 paso a 0", 4);
//					modo_mas_1 = 0;
//					imageV.setBackgroundColor(getResources().getColor(android.R.color.transparent));
//				}
//				refrescarMensaje();
//				return true;
//			}
...
//		});
//
//		encabezado_codigo.setOnLongClickListener(new View.OnLongClickListener() {
//
//					public boolean onLongClick(View v) {
...
//						encabezado_codigo.setBackgroundColor(getResources().getColor(R.color.verde_claro));
//						return true;
//					}
//				});
//
...
//			public boolean onTouch(View view, MotionEvent motionEvent) {
//
//				log.log("[-- 3037 --]" + "Se presiono para ordenar por descripcion", 0);
//				bufferLectoraCB = "";
//				if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
...
//				view.setBackgroundColor(getResources().getColor(R.color.verde_claro));
//
//				if (columna_ordonante != 1) {
//					Collections.sort(listaArticulosCompleta, Articulo.ORDEN_NOM);
//				} else {
//					Collections.reverse(listaArticulosCompleta);
//				}
//				columna_ordonante = 1;
...
//						encabezado_precio_venta.setBackgroundColor(getResources().getColor(R.color.verde_claro));
//						return true;
//					}
//				});
//
...
//					Collections.sort(listaArticulosCompleta, Articulo.ORDEN_CANTIDAD);
//				} else {
//					Collections.reverse(listaArticulosCompleta);
//				}
...
//		});
//
//		encabezado_cantidad.setOnLongClickListener(new View.OnLongClickListener() {
//
//					public boolean onLongClick(View v) {
//
...
//						encabezado_cantidad.setBackgroundColor(getResources().getColor(R.color.verde_claro));
//						return true;
//					}
//				});
//
...
//
//						log.log("[-- 3171 --]" + "Cambia de estado radioVenta", 0);
...
//				});
//
//		radioBDepo.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
//
//					public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
...
//	 *         en el parametro
//	 */
//	private int get_indice_con_articulos(HashMap<Integer, Integer> hashmap) {
...
//			bufferLectoraCB +=bufferLectoraCB.toUpperCase();
...
//				try {
//					processArticuloConCB(bufferLectoraCB.toUpperCase(), true);
//				} catch (ExceptionBDD e) {
//					// TODO Auto-generated catch block
////					e.printStackTrace();
//
...
//							seleccionarMostrarIndiceArticulo(listaArticulosCompleta.size() - 1);
//						}
//					};
//
...
//	 * @throws ExceptionBDD
//	 */
//	private void processArticuloConCB(final String cb, boolean from_lectoraCB) throws ExceptionBDD {
...
//				// 2.1 Entonces agregamos el articulo que no esta en la tabla:
//				// Vemos si el codigo de barras referencia un articulo conocido en la tabla de los articulos:
//				// Si se encuentra el articulo en la base de datos...:
//				Articulo articulo = bdd.selectReferenciaConCodigoBarra(cb);
//				Articulo artComprobacion = bdd.selectArticuloConCodigos(articulo.getSector(), articulo.getCodigo(), this.numeroInventario);
//				boolean seguir = true;
...
//					} // end for
//				}
//				// Articulo articulo =bdd.selectReferenciaArticuloConCodigoBarra(cb);
...
//							a.setFechaInicio(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
//						}
...
//							deseleccionarLineaParticular(indice_on_focus);
//						}
//					}else if(ParametrosInventario.InventariosDeposito && a.getDepsn()==0){ mostrarMensaje(a.getDepsn());
...
//			//
//			loadingBar.setVisibility(View.GONE);
//			ArticuloVisible a_v = listaArticulosCompleta.get(indice_articulo_encontrado);
//			if (!a_v.esVisible()) {
//				showSimpleDialogOK("Articulo Oculto", "El articulo a inventariar esta " + "oculto por un filtro").show();
//			} else {
//
...
//	int size;
//
//	public boolean containsCasero(Object object) {
//		Object[] a = array;
//		int s = size;
//		if (object != null) {
//			for (int i = 2; i < 7; i++) {
...
//				String codBarString = bundle.getString(ParametrosInventario.extra_codBar);
...
//	 * separada por comas
//	 */
//	private ArrayList<String> getCodigosBarra(String codBarString) {
...
public class PaginaInventarioDinamico extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Esto no esta funcionando? habria que ver cuando son muchos articulos
		aguarde = ProgressDialog.show(ctxt, "Aguarde", "Aguarde que se carguen los articulos");
...
//		}
	...
	@NonNull
	private String validar_valor_string(@NonNull String valor_string, Integer Decimales) {
		try {
			Double.parseDouble(valor_string);
			if (Decimales == 0 && Double.parseDouble(valor_string) - Integer.parseInt(valor_string) > 0) {
				return "false";
	 ...
	 * @param grabar_si_no
	 */
	private void deseleccionarLineaParticular(int indice_focused, boolean grabar_si_no) {
		System.out.println("::: PaginaInventarioDinamico deseleccionarLinea int");
		if (indice_focused >= 0) {
			// 1 Buscamos la linea que modificar:
			TableRow lineaFocused = null;
	 ...
	 * @return
	 */
	public AlertDialog showSimpleDialogTimer(String titulo, String mensaje, final int timer_ms) {
		System.out.println("::: PaginaInventarioDinamico show2");
		log.log("[-- 1680--]" + "titulo: " + titulo + ", \n mensaje: "
				+ mensaje + ", \n timer: " + timer_ms, 3);
	...
	public AlertDialog showSimpleDialogSiNo(String titulo, String mensaje, final Class<?> clase) {
	 ...
	 * @throws Exception
	 */
	private int getIndiceArticuloVisibleMasCercanoPorArriba(int indice_anterior) throws Exception {
		System.out.println("::: PaginaInventarioDinamico indiceArticuloVisiblecercano");
		ArticuloVisible a = new ArticuloVisible(false);
		int indice = indice_anterior;
...
//											System.out.println("::::: LLAMADO 1 " + art.getDepsn());
						...
						dialogoResultados.setOnShowListener(new DialogInterface.OnShowListener() {
		...
		encabezado_precio_venta.setOnLongClickListener(new View.OnLongClickListener() {
		...
		radioBVenta.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
		...
		if (event.getKeyCode() == KeyEvent.KEYCODE_DPAD_DOWN) {
			...
			if (Character.isDigit(car)) {
				...
				System.out.println("Ingreso String > " + String.valueOf(car));
					...
					bufferLectoraCB = TextcodigoBarras.getText().toString();
					bufferLectoraCB=bufferLectoraCB.toUpperCase();
			  //bufferLectoraCB+=TextcodigoBarras.getText().toString().toUpperCase();
				//if (event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
...
//		} // end for
	 ...
	 * @param cb
	 */
	private void eliminiarArticuloLista(int codigo, int sector, ArrayList<String> cb) {
		System.out.println("::: PaginaInventarioDinamico EliminarARticulo");
		int indice = 0;
		// Eliminar el articulo de la lista
		ArticuloVisible av;
